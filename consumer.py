...
if __name__ == "__main__":
    ...
    #connect database
    #try:
      #  engine = create_engine('postgresql://postgres:h123s098@localhost:5432/digitalskola')
      #  print(f"[INFO] Successfully Connect Database .....")
    #except:
      #  print(f"[INFO] Error Connect Database .....")
    engine = create_engine('postgresql://postgres:h123s098@172.24.176.1:5432/digitalskola') # ipconfig (powershell) IPv4 Address: 172.24.176.1 , not from ubuntu localhost
